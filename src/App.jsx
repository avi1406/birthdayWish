...
export default function Page() {
  ...
  const handleNoClick = () => {
    ...
    if (nextCount === 1) {
      playMusicSingle(nomusic1);
    }
  };

  const playMusicSingle = (url) => {
    if (currentAudio) {
      currentAudio.pause();
    ...
    audio.muted = isMuted;
    audio.loop = true; // Loop the same song
  ...
  const getNoButtonText = () => {
    ...
    const phrases = [
      ...
      "Rulaegi kya abhi..?",
      "dekh le...!",
      "Tu meri hi hai pta hai na..",
      "hehe bhaut ho gaya... ha bol de abhi ",
      "Yaarrr... aise mat kar please..",
      "Aise karegi ab...",
      "Mera pyara baby... ",
      "Mai rona start kar raha hu abhi...",
      "Ale le le gussa hai kya...",
      "Mere se zyada pyar kon karega..?",
      "I love youuuuuuu... Komal 💖",
      "Are I love you bola fir bhi... 😫",
      "Are you sure you want to do this to me? 😢",
      "Mujhe hurt ho raha hai bigboss.. 😥",
      "I know tu meri hi hai...",
      "Mehnat se bnaya hai yaar.. ha kar do abhi..",
      "Abhi ha bol de aur nhi likha hai aage ;)"
    ];
  ...
  useEffect(() => {
    if (yesPressed && noCount < 4 && !popupShown) {
      Swal.fire({
        title: "I love you sooo Much Baby!!!❤️, Neend , chain sab churaya hai tune mera!!! 🥰💖 But zyada jldi ha bol diya.. Thoda no dabao, Engineer boyfriend (Soon to be husband) ne mehnat ki hai ispe! 🥰✨",
        showClass: {
          popup: `
            animate__animated
            animate__fadeInUp
  ...
  useEffect(() => {
    if (yesPressed && noCount > 3 && !yespopupShown) {
      Swal.fire({
        title: "Finally ha bol diya aapne.. Thenks. On a serious note. My love for you is endless, Tu bhaut special hai mere liye, I don't know ki kya likhu tere liye. Itna kuch bola hai itne saalo me. One thing is sure, I want to marry you, Shaadi karni hai aapse hume. Appke saath bacche karne hai. Appke saath boodha hona hai. So ab to tera picha nhi chodne wala mai kabhi. Tu meri hai I know, but I'll again ask. Will you be my valentine baby? I know you said yes. Phone karke bata diyo abhi mai wait kar raha hu. And Happy birthday baby. I love you soooooooooooooo....  muchhhhhhhhhhh.",
        width: 800,
        padding: "2em",
        color: "#716add",
        background: `#fff url(${swalbg})`,
